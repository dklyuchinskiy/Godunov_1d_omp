...
float left_19[6] = { 0.0f, -1.0f, 0.0f, 1.1f, 0.998f, -0.0001f };
float right_19[6] = { 15.f, 5.0f, 15.f, 1.3f, 1.005f, 0.0001f };

float left_6[6] = { 1.0f, -0.8f, 0.0f, 1.1f, -0.88f, -0.005f };
float right_6[6] = { 5.0f, 0.6f, 4.5f, 1.3f, -0.7f, 0.005f };

float left_7[6] = { 0.2f, -1.4f, 0.2f, 1.1f, 0.0f, 0.0f };
float right_7[6] = { 1.0f, 1.4f, 1.0f, 1.3f, 0.25f, 0.001f };

float left_10[6] = { 1.0f, -0.2f, 1.0f, 1.1f, 0.0f, -0.00001f };
float right_10[6] = { 1.5f, 0.35f, 1.7f, 1.3f, 0.011f, 0.0001f };

float left_11[6] = { 1.4f, 0.0f, 1.4f, 1.1f, -0.28f, -0.0001f };
float right_11[6] = { 2.8f, 0.7f, 3.2f, 1.3f, -0.262f, 0.00025f };
